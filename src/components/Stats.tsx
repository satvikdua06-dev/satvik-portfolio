    ...
    <div className="border border-line bg-panel/80 p-6 backdrop-blur-sm">
      <div className="relative mx-auto size-28">
        <svg viewBox="0 0 100 100" className="size-full -rotate-[135deg]" aria-hidden>
          <circle cx="50" cy="50" r={R} fill="none" stroke="#2e2a1f" strokeWidth="3"
            strokeDasharray={`${C} ${2 * Math.PI * R}`} strokeLinecap="round" />
          <circle cx="50" cy="50" r={R} fill="none" stroke="#d4920f" strokeWidth="3"
...
/** By-the-numbers as a gauge cluster, over the shared background layer. */
export default function Stats() {
  ...
  return (
    <section
      ...
      className="reg-corners relative border-t border-line px-6 py-28 md:px-10"
    >
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-10 font-mono text-[10px] leading-5 tracking-wider text-dim">
          ALSO ON THE BENCH: NEO4J COMPETENCE-MAPPING GRAPH (ONGC HR) · ROBOTICS ·
          DOCKER INFRASTRUCTURE · LONG-EXPOSURE SKY WHEN THE RIGS SLEEP
        </p>
      </div>
    </section>
  );
